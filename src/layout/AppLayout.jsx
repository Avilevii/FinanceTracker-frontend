...
const AppLayout = () => {
  ...
  const headerLeft = (
    <Box sx={{ display: "flex", alignItems: "center", gap: 2, ml: { md: 2 } }}>
      {!isDesktop && <HamburgerMenu onClick={() => setOpen(true)} />}
  ...
  return (
    ...
    >
      ...
      >
        <Outlet
          context={{ setHeaderCenter, setHeaderRight, setHeaderLeftExtra }}
        />
      </Box>
    </Box>
  );
